...
"""
data_file_name = 'housing_permutation.npz'
complete_data_file_name = os.path.join(data_loc_assignment2,data_file_name)
npzfile_1 = np.load(complete_data_file_name)
...
x_train_1, x_test_1, y_train_1, y_test_1 = dshelp.load_data_npz(npzfile_1, labels_train = "y_train", labels_test = "y_test")
